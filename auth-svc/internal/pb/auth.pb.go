...
var file_internal_pb_auth_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x27, 0x0a, 0x0f,
	...
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x03, 0x5a,
...
func file_internal_pb_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_pb_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internal_pb_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internal_pb_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_pb_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_internal_pb_auth_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_internal_pb_auth_proto_msgTypes[5].Exporter = func(v any, i int) any {
