...
var file_internal_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x27, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
...
var file_internal_auth_pb_auth_proto_goTypes = []any{
...
func file_internal_auth_pb_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_auth_pb_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internal_auth_pb_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internal_auth_pb_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_auth_pb_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_internal_auth_pb_auth_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_internal_auth_pb_auth_proto_msgTypes[5].Exporter = func(v any, i int) any {
